...
class JsonHard6 extends StatelessWidget {
  String assettoload;
  // String langname;
  // Json(this.langname);

  setasset() {
    assettoload = "assets/kuizjson/json6/json6susah.json";
  }
    ...
    return FutureBuilder(
      ...
      builder: (context, snapshot) {
        ...
        if (mydata == null) {
          ...
          return Kuiz6Susah(mydata: mydata);
        }
      },
    );
  }
...
class Kuiz6Susah extends StatefulWidget {
  var mydata;
  Kuiz6Susah({Key key, @required this.mydata}) : super(key: key);

  @override
  _Kuiz6SusahState createState() => _Kuiz6SusahState(mydata);
}

class _Kuiz6SusahState extends State<Kuiz6Susah> {
  var mydata;
  _Kuiz6SusahState(this.mydata);
