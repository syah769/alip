...
class JsonEasy6 extends StatelessWidget {
  String assettoload;
  // String langname;
  // Json(this.langname);

  setasset() {
    assettoload = "assets/kuizjson/json6/json6senang.json";
  }
    ...
    return FutureBuilder(
      ...
      builder: (context, snapshot) {
        ...
        if (mydata == null) {
          ...
          return Kuiz6Senang(mydata: mydata);
        }
      },
    );
  }
...
class Kuiz6Senang extends StatefulWidget {
  var mydata;
  Kuiz6Senang({Key key, @required this.mydata}) : super(key: key);

  @override
  _Kuiz6SenangState createState() => _Kuiz6SenangState(mydata);
}

class _Kuiz6SenangState extends State<Kuiz6Senang> {
  var mydata;
  _Kuiz6SenangState(this.mydata);
