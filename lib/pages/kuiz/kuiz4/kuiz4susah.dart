...
class JsonHard4 extends StatelessWidget {
  String assettoload;
  // String langname;
  // Json(this.langname);

  setasset() {
    assettoload = "assets/kuizjson/json4/json4susah.json";
  }
    ...
    return FutureBuilder(
      ...
      builder: (context, snapshot) {
        ...
        if (mydata == null) {
          ...
          return Kuiz4Susah(mydata: mydata);
        }
      },
    );
  }
...
class Kuiz4Susah extends StatefulWidget {
  var mydata;
  Kuiz4Susah({Key key, @required this.mydata}) : super(key: key);

  @override
  _Kuiz4SusahState createState() => _Kuiz4SusahState(mydata);
}

class _Kuiz4SusahState extends State<Kuiz4Susah> {
  var mydata;
  _Kuiz4SusahState(this.mydata);
