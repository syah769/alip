...
class JsonEasy4 extends StatelessWidget {
  String assettoload;
  // String langname;
  // Json(this.langname);

  setasset() {
    assettoload = "assets/kuizjson/json4/json4senang.json";
  }
    ...
    return FutureBuilder(
      ...
      builder: (context, snapshot) {
        ...
        if (mydata == null) {
          ...
          return Kuiz4Senang(mydata: mydata);
        }
      },
    );
  }
...
class Kuiz4Senang extends StatefulWidget {
  var mydata;
  Kuiz4Senang({Key key, @required this.mydata}) : super(key: key);

  @override
  _Kuiz4SenangState createState() => _Kuiz4SenangState(mydata);
}

class _Kuiz4SenangState extends State<Kuiz4Senang> {
  var mydata;
  _Kuiz4SenangState(this.mydata);
