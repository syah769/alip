...
class JsonHard8 extends StatelessWidget {
  String assettoload;
  // String langname;
  // Json(this.langname);

  setasset() {
    assettoload = "assets/kuizjson/json8/json8susah.json";
  }
    ...
    return FutureBuilder(
      ...
      builder: (context, snapshot) {
        ...
        if (mydata == null) {
          ...
          return Kuiz8Susah(mydata: mydata);
        }
      },
    );
  }
...
class Kuiz8Susah extends StatefulWidget {
  var mydata;
  Kuiz8Susah({Key key, @required this.mydata}) : super(key: key);

  @override
  _Kuiz8SusahState createState() => _Kuiz8SusahState(mydata);
}

class _Kuiz8SusahState extends State<Kuiz8Susah> {
  var mydata;
  _Kuiz8SusahState(this.mydata);
