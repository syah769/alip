...
class JsonEasy8 extends StatelessWidget {
  String assettoload;
  // String langname;
  // Json(this.langname);

  setasset() {
    assettoload = "assets/kuizjson/json8/json8senang.json";
  }
    ...
    return FutureBuilder(
      ...
      builder: (context, snapshot) {
        ...
        if (mydata == null) {
          ...
          return Kuiz8Senang(mydata: mydata);
        }
      },
    );
  }
...
class Kuiz8Senang extends StatefulWidget {
  var mydata;
  Kuiz8Senang({Key key, @required this.mydata}) : super(key: key);

  @override
  _Kuiz8SenangState createState() => _Kuiz8SenangState(mydata);
}

class _Kuiz8SenangState extends State<Kuiz8Senang> {
  var mydata;
  _Kuiz8SenangState(this.mydata);
