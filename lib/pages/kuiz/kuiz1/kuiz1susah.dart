...
class JsonHard1 extends StatelessWidget {
  String assettoload;
  // String langname;
  // Json(this.langname);

  setasset() {
    assettoload = "assets/kuizjson/json1/json1susah.json";
  }
    ...
    return FutureBuilder(
      ...
      builder: (context, snapshot) {
        ...
        if (mydata == null) {
          ...
          return Kuiz1Susah(mydata: mydata);
        }
      },
    );
  }
...
class Kuiz1Susah extends StatefulWidget {
  var mydata;
  Kuiz1Susah({Key key, @required this.mydata}) : super(key: key);

  @override
  _Kuiz1SusahState createState() => _Kuiz1SusahState(mydata);
}

class _Kuiz1SusahState extends State<Kuiz1Susah> {
  var mydata;
  _Kuiz1SusahState(this.mydata);
