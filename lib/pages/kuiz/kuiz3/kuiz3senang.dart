...
class JsonEasy3 extends StatelessWidget {
  String assettoload;
  // String langname;
  // Json(this.langname);

  setasset() {
    assettoload = "assets/kuizjson/json3/json3senang.json";
  }
    ...
    return FutureBuilder(
      ...
      builder: (context, snapshot) {
        ...
        if (mydata == null) {
          ...
          return Kuiz3Senang(mydata: mydata);
        }
      },
    );
  }
...
class Kuiz3Senang extends StatefulWidget {
  var mydata;
  Kuiz3Senang({Key key, @required this.mydata}) : super(key: key);

  @override
  _Kuiz3SenangState createState() => _Kuiz3SenangState(mydata);
}

class _Kuiz3SenangState extends State<Kuiz3Senang> {
  var mydata;
  _Kuiz3SenangState(this.mydata);
