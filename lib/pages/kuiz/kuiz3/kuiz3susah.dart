...
class JsonHard3 extends StatelessWidget {
  String assettoload;
  // String langname;
  // Json(this.langname);

  setasset() {
    assettoload = "assets/kuizjson/json3/json3susah.json";
  }
    ...
    return FutureBuilder(
      ...
      builder: (context, snapshot) {
        ...
        if (mydata == null) {
          ...
          return Kuiz3Susah(mydata: mydata);
        }
      },
    );
  }
...
class Kuiz3Susah extends StatefulWidget {
  var mydata;
  Kuiz3Susah({Key key, @required this.mydata}) : super(key: key);

  @override
  _Kuiz3SusahState createState() => _Kuiz3SusahState(mydata);
}

class _Kuiz3SusahState extends State<Kuiz3Susah> {
  var mydata;
  _Kuiz3SusahState(this.mydata);
