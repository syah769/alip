...
class JsonEasy7 extends StatelessWidget {
  String assettoload;
  // String langname;
  // Json(this.langname);

  setasset() {
    assettoload = "assets/kuizjson/json7/json7senang.json";
  }
    ...
    return FutureBuilder(
      ...
      builder: (context, snapshot) {
        ...
        if (mydata == null) {
          ...
          return Kuiz7Senang(mydata: mydata);
        }
      },
    );
  }
...
class Kuiz7Senang extends StatefulWidget {
  var mydata;
  Kuiz7Senang({Key key, @required this.mydata}) : super(key: key);

  @override
  _Kuiz7SenangState createState() => _Kuiz7SenangState(mydata);
}

class _Kuiz7SenangState extends State<Kuiz7Senang> {
  var mydata;
  _Kuiz7SenangState(this.mydata);
