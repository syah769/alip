...
class JsonHard7 extends StatelessWidget {
  String assettoload;
  // String langname;
  // Json(this.langname);

  setasset() {
    assettoload = "assets/kuizjson/json7/json7susah.json";
  }
    ...
    return FutureBuilder(
      ...
      builder: (context, snapshot) {
        ...
        if (mydata == null) {
          ...
          return Kuiz7Susah(mydata: mydata);
        }
      },
    );
  }
...
class Kuiz7Susah extends StatefulWidget {
  var mydata;
  Kuiz7Susah({Key key, @required this.mydata}) : super(key: key);

  @override
  _Kuiz7SusahState createState() => _Kuiz7SusahState(mydata);
}

class _Kuiz7SusahState extends State<Kuiz7Susah> {
  var mydata;
  _Kuiz7SusahState(this.mydata);
