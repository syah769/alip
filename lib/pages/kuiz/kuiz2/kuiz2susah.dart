...
class JsonHard2 extends StatelessWidget {
  String assettoload;
  // String langname;
  // Json(this.langname);

  setasset() {
    assettoload = "assets/kuizjson/json2/json2susah.json";
  }
    ...
    return FutureBuilder(
      ...
      builder: (context, snapshot) {
        ...
        if (mydata == null) {
          ...
          return Kuiz2Susah(mydata: mydata);
        }
      },
    );
  }
...
class Kuiz2Susah extends StatefulWidget {
  var mydata;
  Kuiz2Susah({Key key, @required this.mydata}) : super(key: key);

  @override
  _Kuiz2SusahState createState() => _Kuiz2SusahState(mydata);
}

class _Kuiz2SusahState extends State<Kuiz2Susah> {
  var mydata;
  _Kuiz2SusahState(this.mydata);
