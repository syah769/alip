...
class JsonEasy2 extends StatelessWidget {
  String assettoload;
  // String langname;
  // Json(this.langname);

  setasset() {
    assettoload = "assets/kuizjson/json2/json2senang.json";
  }
    ...
    return FutureBuilder(
      ...
      builder: (context, snapshot) {
        ...
        if (mydata == null) {
          ...
          return Kuiz2Senang(mydata: mydata);
        }
      },
    );
  }
...
class Kuiz2Senang extends StatefulWidget {
  var mydata;
  Kuiz2Senang({Key key, @required this.mydata}) : super(key: key);

  @override
  _Kuiz2SenangState createState() => _Kuiz2SenangState(mydata);
}

class _Kuiz2SenangState extends State<Kuiz2Senang> {
  var mydata;
  _Kuiz2SenangState(this.mydata);
