...
class JsonEasy9 extends StatelessWidget {
  String assettoload;
  // String langname;
  // Json(this.langname);

  setasset() {
    assettoload = "assets/kuizjson/json9/json9senang.json";
  }
    ...
    return FutureBuilder(
      ...
      builder: (context, snapshot) {
        ...
        if (mydata == null) {
          ...
          return Kuiz9Senang(mydata: mydata);
        }
      },
    );
  }
...
class Kuiz9Senang extends StatefulWidget {
  var mydata;
  Kuiz9Senang({Key key, @required this.mydata}) : super(key: key);

  @override
  _Kuiz9SenangState createState() => _Kuiz9SenangState(mydata);
}

class _Kuiz9SenangState extends State<Kuiz9Senang> {
  var mydata;
  _Kuiz9SenangState(this.mydata);
