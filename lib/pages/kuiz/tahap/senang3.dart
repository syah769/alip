...
class Senang3 extends StatefulWidget {
  final String weapon;
  Senang3({Key key, this.weapon}) : super(key: key);
  @override
  _Senang3State createState() => _Senang3State();
}

class _Senang3State extends State<Senang3> with TickerProviderStateMixin {
              ...
              FlatButton(
                ...
                onPressed: () {
                  Navigator.of(context).push(MaterialPageRoute(
                      builder: (BuildContext context) => JsonEasy3()));
                },
              ),
            ],
          );
