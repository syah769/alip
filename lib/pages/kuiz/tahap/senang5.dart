...
class Senang5 extends StatefulWidget {
  final String weapon;
  Senang5({Key key, this.weapon}) : super(key: key);
  @override
  _Senang5State createState() => _Senang5State();
}

class _Senang5State extends State<Senang5> with TickerProviderStateMixin {
