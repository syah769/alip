...
class Susah5 extends StatefulWidget {
  final String weapon;
  Susah5({Key key, this.weapon}) : super(key: key);
  @override
  _Susah5State createState() => _Susah5State();
}

class _Susah5State extends State<Susah5> with TickerProviderStateMixin {
