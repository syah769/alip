...
class Senang1 extends StatefulWidget {
  final String weapon;
  Senang1({Key key, this.weapon}) : super(key: key);
  @override
  _Senang1State createState() => _Senang1State();
}

class _Senang1State extends State<Senang1> with TickerProviderStateMixin {
