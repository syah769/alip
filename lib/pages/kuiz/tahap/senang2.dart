...
class Senang2 extends StatefulWidget {
  final String weapon;
  Senang2({Key key, this.weapon}) : super(key: key);
  @override
  _Senang2State createState() => _Senang2State();
}

class _Senang2State extends State<Senang2> with TickerProviderStateMixin {
              ...
              FlatButton(
                ...
                onPressed: () {
                  Navigator.of(context).push(MaterialPageRoute(
                      builder: (BuildContext context) => JsonEasy2()));
                },
              ),
            ],
          );
