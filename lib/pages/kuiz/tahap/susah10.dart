...
import 'package:sains/pages/kuiz/kuiz10/kuiz10susah.dart';
import 'package:sains/theme/designCourseAppTheme.dart';

class Susah10 extends StatefulWidget {
  final String weapon;
  Susah10({Key key, this.weapon}) : super(key: key);
  @override
  _Susah10State createState() => _Susah10State();
}

class _Susah10State extends State<Susah10> with TickerProviderStateMixin {
              ...
              FlatButton(
                ...
                onPressed: () {
                  Navigator.of(context).push(MaterialPageRoute(
                      builder: (BuildContext context) => JsonHard10()));
                },
              ),
            ],
          );
