...
class JsonHard10 extends StatelessWidget {
  String assettoload;
  // String langname;
  // Json(this.langname);

  setasset() {
    assettoload = "assets/kuizjson/json10/json10susah.json";
  }
    ...
    return FutureBuilder(
      ...
      builder: (context, snapshot) {
        ...
        if (mydata == null) {
          ...
          return Kuiz10Susah(mydata: mydata);
        }
      },
    );
  }
...
class Kuiz10Susah extends StatefulWidget {
  var mydata;
  Kuiz10Susah({Key key, @required this.mydata}) : super(key: key);

  @override
  _Kuiz10SusahState createState() => _Kuiz10SusahState(mydata);
}

class _Kuiz10SusahState extends State<Kuiz10Susah> {
  var mydata;
  _Kuiz10SusahState(this.mydata);
