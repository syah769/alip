...
class JsonEasy10 extends StatelessWidget {
  String assettoload;
  // String langname;
  // Json(this.langname);

  setasset() {
    assettoload = "assets/kuizjson/json10/json10senang.json";
  }
    ...
    return FutureBuilder(
      ...
      builder: (context, snapshot) {
        ...
        if (mydata == null) {
          ...
          return Kuiz10Senang(mydata: mydata);
        }
      },
    );
  }
...
class Kuiz10Senang extends StatefulWidget {
  var mydata;
  Kuiz10Senang({Key key, @required this.mydata}) : super(key: key);

  @override
  _Kuiz10SenangState createState() => _Kuiz10SenangState(mydata);
}

class _Kuiz10SenangState extends State<Kuiz10Senang> {
  var mydata;
  _Kuiz10SenangState(this.mydata);
